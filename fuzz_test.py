...
print "\n After finding bad chars restart the vulnerable service and your debugger. Press enter to continue"
raw_input()
 
print "Please enter the full command of the msf payload you would like to generate with the bad characters that were found"
...
print "Find JMP address with the mona command and then specify the address to jump to (Big Endian)"
